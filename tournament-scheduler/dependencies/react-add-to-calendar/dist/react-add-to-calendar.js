...
})(this, (__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_8__) =>
/******/(function (modules) { // webpackBootstrap
  ...
  /******/([
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var _createClass = function () { function defineProperties(target, props) { for (var descriptor of props) { descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ('value' in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor) } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor } }()

      var _react = __webpack_require__(1)

      var _react2 = _interopRequireDefault(_react)

      var _propertyTypes = __webpack_require__(2)

      var _propertyTypes2 = _interopRequireDefault(_propertyTypes)
      ...
      var ReactAddToCalendar = function (_React$Component) {
        ...
        _createClass(ReactAddToCalendar, [{
          ...
          value: function toggleCalendarDropdown() {
            ...
            if (showOptions) {
              document.addEventListener('click', this.toggleCalendarDropdown, { capture: true })
            } else {
              document.removeEventListener('click', this.toggleCalendarDropdown, { capture: true })
            }
          ...
          value: function renderDropdown() {
            ...
            var items = this.props.listItems.map(listItem => {
          ...
          value: function render() {
            ...
            var addToCalendarButton = null
            if (this.props.event) {
              addToCalendarButton = this.renderButton()
            }
      ...
      ReactAddToCalendar.propTypes = {
        buttonClassClosed: _propertyTypes2.default.string,
        buttonClassOpen: _propertyTypes2.default.string,
        buttonLabel: _propertyTypes2.default.string,
        buttonTemplate: _propertyTypes2.default.object,
        buttonIconClass: _propertyTypes2.default.string,
        useFontAwesomeIcons: _propertyTypes2.default.bool,
        buttonWrapperClass: _propertyTypes2.default.string,
        displayItemIcons: _propertyTypes2.default.bool,
        optionsOpen: _propertyTypes2.default.bool,
        dropdownClass: _propertyTypes2.default.string,
        event: _propertyTypes2.default.shape({
          title: _propertyTypes2.default.string,
          description: _propertyTypes2.default.string,
          location: _propertyTypes2.default.string,
          startTime: _propertyTypes2.default.string,
          endTime: _propertyTypes2.default.string
        }).isRequired,
        listItems: _propertyTypes2.default.arrayOf(_propertyTypes2.default.object),
        rootClass: _propertyTypes2.default.string
      }
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var ReactPropertyTypesSecret = __webpack_require__(6)

      module.exports = function () {
        function shim(props, propertyName, componentName, location, propertyFullName, secret) {
          if (secret === ReactPropertyTypesSecret) {
        ...
        ReactPropertyTypes.checkPropTypes = emptyFunction
        ReactPropertyTypes.PropTypes = ReactPropertyTypes

        return ReactPropertyTypes
      }
    ...
    /***/ function (module, exports) {
      ...
      function makeEmptyFunction(argument) {
        return function () {
          return argument
        }
      }
      ...
      function invariant(condition, format, a, b, c, d, e, f) {
        ...
        if (!condition) {
          ...
          if (format === undefined) {
            ...
            var argumentIndex = 0
            error = new Error(format.replace(/%s/g, () => args[argumentIndex++]))
    ...
    /***/ function (module, exports) {
      ...
      var ReactPropertyTypesSecret = 'SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED'

      module.exports = ReactPropertyTypesSecret
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var helpers = function () {
        ...
        _createClass(helpers, [{
          ...
          key: 'formatOutlookTime',
          value: function formatOutlookTime(date) {
          ...
          value: function buildUrl(event, type, isCrappyIE) {
            ...
            switch (type) {
              ...
              case 'outlookcom':
                ...
                calendarUrl += `&startdt=${this.formatOutlookTime(event.startTime)}`
                calendarUrl += `&enddt=${this.formatOutlookTime(event.endTime)}`
